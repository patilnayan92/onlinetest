...
import re
# Local imports.
from nayan.code_server import get_result as get_result_from_code_server, SERVER_POOL_PORT
from nayan.models import (
...
"""def user_register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            message = render_to_string('nayan/acc_active_email.html', {
                'user':user,
            ...
            email.send()
            return my_render_to_response('Please confirm your email address to complete the registration')

    else:
        form = UserRegisterForm()

    return my_render_to_response(request, 'nayan/register.html', {'form': form})
...
def activate(request, uidb64, token):
    ...
    if user is not None and account_activation_token.check_token(user, token):
        ...
        return my_render_to_response('Thank you for your email confirmation. Now you can login your account.')
        return my_render_to_response('nayan/login.html')
    else:
        return my_render_to_response('Activation link is invalid!')
"""
        ...
        if form.is_valid():
            ...
            if user_email and key:
                ...
                return my_render_to_response(
                    'nayan/activation_status.html', context
                )
            return index(request)
        else:
            return my_render_to_response('nayan/register.html', {'form': form},
                                         context_instance=ci)
    else:
        form = UserRegisterForm()
        return my_render_to_response(
            'nayan/register.html', {'form': form}, context_instance=ci
        )
...
def user_logout(request):
    ...
    return my_render_to_response('nayan/complete.html', context)
...
def view_profile(request):
    ...
    return my_render_to_response('nayan/view_profile.html', context)
...
def quizlist_user(request, enrolled=None):
    ...
    return my_render_to_response(
        "nayan/quizzes_user.html", context, context_instance=ci
    )
...
def results_user(request):
    ...
    return my_render_to_response("nayan/results_user.html", context)
...
def add_question(request, question_id=None):
    ...
    if request.method == 'POST':
        ...
        if qform.is_valid():
            ...
            return my_render_to_response(
                "nayan/add_question.html", context, context_instance=ci
            )
...
def add_quiz(request, course_id, quiz_id=None):
    ...
    context["form"] = form
    return my_render_to_response(
        'nayan/add_quiz.html', context, context_instance=ci
    )
...
def prof_manage(request, msg=None):
    ...
    if user.is_authenticated() and is_moderator(user):
        ...
        return my_render_to_response(
            'nayan/moderator_dashboard.html', context, context_instance=ci
        )
    return my_redirect('/exam/login/')
...
def user_login(request):
    ...
    return my_render_to_response('nayan/login.html', context,
                                 context_instance=ci)
...
def start(request, questionpaper_id=None, attempt_num=None):
    ...
    if attempt_num is None:
        ...
        return my_render_to_response('nayan/intro.html', context,
                                     context_instance=ci)
    else:
...
def show_question(request, question, paper, error_message=None, notification=None):
    ...
    ci = RequestContext(request)
    return my_render_to_response('nayan/question.html', context,
                                 context_instance=ci)
...
def quit(request, reason=None, attempt_num=None, questionpaper_id=None):
    ...
    return my_render_to_response('nayan/quit.html', context,
...
def add_course(request, course_id=None):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return my_render_to_response(
                'nayan/add_course.html', {'form': form}, context_instance=ci
            )
    else:
...
def courses(request):
    ...
    return my_render_to_response('nayan/courses.html', context,
                                 context_instance=ci)
...
def course_detail(request, course_id):
    ...
    return my_render_to_response(
        'nayan/course_detail.html', {'course': course}, context_instance=ci
    )
...
def send_mail(request, course_id, user_id=None):
    ...
    return my_render_to_response(
        'nayan/course_detail.html', context, context_instance=ci
    )
...
def reject(request, course_id, user_id=None, was_enrolled=False):
    ...
    if not reject_ids:
        ...
        return my_render_to_response(
            'nayan/course_detail.html', {'course': course, 'message': message},
            context_instance=ci
        )
...
def show_statistics(request, questionpaper_id, attempt_number=None):
    ...
    if attempt_number is None:
        ...
        return my_render_to_response('nayan/statistics_question.html', context,
                                     context_instance=RequestContext(request))
...
def monitor(request, quiz_id=None):
    ...
    if quiz_id is None:
        ...
        return my_render_to_response(
            'nayan/monitor.html', context, context_instance=ci
        )
    # quiz_id is not None.
    try:
    ...
    return my_render_to_response('nayan/monitor.html', context,
                                 context_instance=ci)
...
def ajax_questions_filter(request):
    ...
    return my_render_to_response(
        'nayan/ajax_question_filter.html', {'questions': questions}
    )
...
def design_questionpaper(request, quiz_id, questionpaper_id=None):
    ...
    return my_render_to_response(
        'nayan/design_questionpaper.html',
        context,
        context_instance=RequestContext(request)
    )
...
def show_all_questions(request):
    ...
    return my_render_to_response('nayan/showquestions.html', context,
                                 context_instance=ci)
...
def user_data(request, user_id, questionpaper_id=None):
    ...
    context = {'data': data}
    return my_render_to_response('nayan/user_data.html', context,
                                 context_instance=RequestContext(request))
...
def grade_user(request, quiz_id=None, user_id=None, attempt_number=None):
    ...
    return my_render_to_response(
        'nayan/grade_user.html', context, context_instance=ci
    )
...
def edit_profile(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form_data.save()
            return my_render_to_response(
                'nayan/profile_updated.html', context_instance=ci
            )
        else:
            context['form'] = form
            return my_render_to_response(
                'nayan/editprofile.html', context, context_instance=ci
            )
    else:
...
def student_user(request):
    entries = User.objects.all()[1:]
    #if not is_moderator(students):
    return render_to_response('nayan/studentuser.html', {'User' : entries})
...
def search_teacher(request, course_id):
    ...
    return my_render_to_response(
        'nayan/addteacher.html', context, context_instance=ci
    )
...
def view_answerpaper(request, questionpaper_id):
    ...
    if quiz.view_answerpaper and user in quiz.course.students.all():
        ...
        return my_render_to_response('nayan/view_answerpaper.html', context)
    else:
        return my_redirect('/exam/quizzes/')
...
def grader(request, extra_context=None):
    ...
    return my_render_to_response('nayan/regrade.html', context)
...
def activate_user(request, key):
    ...
    if profile.is_email_verified:
        ...
        return my_render_to_response(
            'nayan/activation_status.html', context, context_instance=ci
        )
...
def upload_users(request, course_id):
    ...
    if request.method == 'POST':
        if 'csv_file' not in request.FILES:
            ...
            return my_render_to_response('nayan/course_detail.html', context,
                                         context_instance=ci)
